...
import com.appvillis.assistant_core.view.NgWidgetsHelper;
import com.appvillis.assistant_core.view.NgWidgetsView;
...
//        }
    ...
    // region ng pinned chats fix
    private boolean hasNgWidgetsType() {
        for (int i = 0; i < getItemCount(); i++) {
            int type = getItemViewType(i);
            if(type == VIEW_TYPE_NG_WIDGETS) {
                return true;
            }
        }
        return false;
